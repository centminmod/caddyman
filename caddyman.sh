...
declare -A plugins_urls=(
    ...
    # ["net"]="github.com/pieterlouw/caddy-net/caddynet"
    ...
    # ["supervisor-http"]="github.com/lucaslorentz/caddy-supervisor/httpplugin"
    # ["supervisor-type"]="github.com/lucaslorentz/caddy-supervisor/servertype"
